...
public class Top extends Item{
    ...
    public Top(String selectedSeason, String selectedOccasion, String selectedColor, String selectedType, String filename, String description) {
        super(selectedSeason, selectedOccasion, selectedColor, filename, description);
        setTypeOfTop(selectedType);
    }
    
    //constructor without description
    public Top(String selectedSeason, String selectedOccasion, String selectedColor, String selectedType, String filename) {
