...
public class HomePane extends HBox {
    ...
    public HomePane(App ap, int i){
	    ...
	    ImageView profile = new ImageView("Profile2.png");
	    ...
	    Image img1 = new Image("Wardrobe.jpg");
	    ...
	    //crea l'immagine all'interno del button 
	    Image img2 = new Image("Wardrobe.jpg");
	    ...
	    //crea l'immagine all'interno del button 
	    Image img3 = new Image("Wardrobe.jpg");
	    ...
	    //crea l'immagine all'interno del button 
	    Image img4 = new Image("Wardrobe.jpg");
	    ...
	    //crea l'immagine all'interno del button 
	    Image img5 = new Image("Wardrobe.jpg");
	    ...
	    //crea l'immagine all'interno del button 
	    Image img6 = new Image("Wardrobe.jpg");
	    ...
	    setStyle("-fx-background-color: white; -fx-background-image:url('Wardrobe.jpg');-fx-background-repeat: no-repeat; -fx-background-size: 700 400; -fx-background-position: center center;");
	    ...
	    //se premuto deve far vedere gli items in base ai filtri
	        ...
	        card1.setOnAction(new EventHandler<ActionEvent>() {
	            public void handle(ActionEvent t) {
	                Stage stage2 = new Stage();
	                Scene scene = new Scene(new PopUpPane(), 300, 300);
	                stage2.setTitle("PopUp");
	                stage2.setScene(scene);
	                stage2.show();
	            }
