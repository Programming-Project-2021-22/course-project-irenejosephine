public class Accessorize extends Item{
    ...
    public Accessorize(String selectedSeason, String selectedOccasion, String selectedColor, String selectedType, String filename, String description ) {
        super(selectedSeason, selectedOccasion, selectedColor, filename, description);
        setTypeOfAccesorize(selectedType);
    }
    
    //constructor without description
    public Accessorize(String selectedSeason, String selectedOccasion, String selectedColor, String selectedType, String filename ) {
